...
export sem=$( curl -s https://raw.githubusercontent.com/yanzwrt/RPAVPN2/main/test/versions)
...
clear
green_dot="\033[1;92m●\033[0m"
red_dot="\033[1;91m●\033[0m"

[[ "$ressh" == *"ON"* ]] && ssh_status="$green_dot" || ssh_status="$red_dot"
[[ "$resngx" == *"ON"* ]] && nginx_status="$green_dot" || nginx_status="$red_dot"
[[ "$resv2r" == *"ON"* ]] && xray_status="$green_dot" || xray_status="$red_dot"
[[ "$resdbr" == *"ON"* ]] && dropbear_status="$green_dot" || dropbear_status="$red_dot"
[[ "$ressshws" == *"ON"* ]] && sshws_status="$green_dot" || sshws_status="$red_dot"
...
echo -e "${BICyan}║ ${BICyan}CPU        :${BIWhite} $cores Cores @ $freq MHz ($cpu_usage)${NC}"
echo -e "${BICyan}║ ${BICyan}RAM        :${BIWhite} $ram_used MB / $total_ram MB (${ram_usage}%)${NC}"
echo -e "${BICyan}║ ${BICyan}Uptime     :${BIWhite} $uptime${NC}"
echo -e "${BICyan}║ ${BICyan}Domain     :${BIWhite} $(cat /etc/xray/domain)${NC}"
echo -e "${BICyan}║ ${BICyan}IP VPS     :${BIWhite} $IPVPS${NC}"
echo -e "${BICyan}║ ${BICyan}Bandwidth  :${BIWhite} Daily: $daily_usage / Monthly: $monthly_usage${NC}"
echo -e "${BICyan}╚══════════════════════════════════════════════════════════════╝${NC}"

echo -e "${BIPurple} Service Status ${NC}:"
echo -e "   ${BICyan}SSH${NC}: $ssh_status   ${BICyan}NGINX${NC}: $nginx_status   ${BICyan}XRAY${NC}: $xray_status   ${BICyan}DROPBEAR${NC}: $dropbear_status"
...
echo -e "  ${BICyan}[${BIWhite}05${BICyan}] SHADOWSOCKS      ${BICyan}[${BIWhite}10${BICyan}] BACKUP/RESTORE    ${BICyan}[${BIWhite}15${BICyan}] USER BANDWIDTH"
echo -e ""
echo -e "  ${BICyan}[${BIWhite}16${BICyan}] SPEEDTEST        ${BICyan}[${BIWhite}17${BICyan}] CHECK BANDWIDTH   ${BICyan}[${BIWhite}18${BICyan}] LIMIT SPEED"
echo -e "  ${BICyan}[${BIWhite}19${BICyan}] WEBMIN           ${BICyan}[${BIWhite}20${BICyan}] INFO SCRIPT       ${BICyan}[${BIWhite}21${BICyan}] CLEAR LOG"
echo -e "  ${BICyan}[${BIWhite}22${BICyan}] TASK MANAGER     ${BICyan}[${BIWhite}23${BICyan}] DNS CHANGER       ${BICyan}[${BIWhite}24${BICyan}] NETFLIX CHECKER"
echo -e "  ${BICyan}[${BIWhite}25${BICyan}] TENDANG          ${BICyan}[${BIWhite}55${BICyan}] XRAY-CORE MENU    ${BICyan}[${BIWhite}66${BICyan}] INSTALL BBRPLUS"
echo -e "  ${BICyan}[${BIWhite}77${BICyan}] SWAPRAM MENU     ${BICyan}[${BIWhite}88${BICyan}] BACKUP            ${BICyan}[${BIWhite}99${BICyan}] RESTORE"
echo -e ""
echo -e "  ${BICyan}[${BIWhite}x ${BICyan}] EXIT PANEL"
echo -e "${BIPurple}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BICyan}Version : ${BIWhite}$sem${NC} ─ Last Update | Author: ${BIWhite}$Auther${NC}"
echo
...
#22) clear ; wget https://raw.githubusercontent.com/yanzwrt/RPAVPN2/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
#25) clear ; del-xrays ;;
#30) clear ; user-xrays ;;
0) clear ; menu ;;
x) exit ;;
